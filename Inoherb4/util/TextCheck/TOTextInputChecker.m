 ...
 *  @return 检查器
 */
+(TOTextInputChecker *)defaultChecker{
    TOTextInputChecker * check = [[TOTextInputChecker alloc] init];
    check.keyboardType = UIKeyboardTypeDefault;
    check.type =  InputCheckTypeMaxLength | InputCheckTypeMinLength | InputCheckTypeNotNull;
...
- (void)textFieldDidEndEditing:(C_TextField *)textField{
    ...
    [textField setData:textField.text];

...
@implementation Frm_RootView

@synthesize startTouch,lastScreenShotView,blackMask,dragBack;
//Frm_RootView* mInstance;
//
//-(Frm_RootView*) newInstance :(UIViewController*)login canDragBack:(BOOL)canDragBack
//{
//    mInstance =[[Frm_RootView alloc] init:login canDragBack:canDragBack];
//    return mInstance;
//}
...
- (void)paningGestureReceive:(UIPanGestureRecognizer *)recoginzer
{
    ...
    if (self.viewControllers.count <= 1 || !dragBack) return;
